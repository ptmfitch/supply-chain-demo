    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <DialogHeader className={DIALOG_EDGE_SCROLL_HEADER}>
          ...
          <DialogDescription className="text-gray-600 dark:text-gray-700 dark:text-white/80">
        ...
        <div className={cn(DIALOG_EDGE_SCROLL_BODY, "overflow-y-auto overflow-x-visible")}>
          <div className={cn(DIALOG_EDGE_SCROLL_INNER, "gap-4")}>
            ...
            <div className="rounded-xl border border-white/15 bg-white/5 p-3 space-y-3">
              <p className="text-xs font-medium text-gray-600 dark:text-gray-700 dark:text-white/80">Order items</p>
              <ProductLineItemsList
                items={order.items ?? []}
                linkMode="none"
            ...
            >
              <TabsList className="grid w-full grid-cols-2 h-11 p-1 rounded-lg bg-white/30 dark:bg-white/10 text-gray-700 dark:text-white shrink-0 border border-emerald-400/30 dark:border-white/20 shadow-sm">
                <TabsTrigger
                  value="auto"
                  className="h-9 gap-2 rounded-md data-[state=active]:border data-[state=active]:border-emerald-400 data-[state=active]:ring-2 data-[state=active]:ring-emerald-500/50 data-[state=active]:bg-background data-[state=active]:text-slate-700 dark:data-[state=active]:text-gray-700 dark:text-white dark:data-[state=active]:bg-white/20"
                >
                  <Truck className="h-4 w-4" />
                  Auto Generate
                </TabsTrigger>
              ...
              <TabsContent
                ...
                className="space-y-4 mt-4 data-[state=inactive]:hidden"
              >
                <p className="text-sm text-gray-500 dark:text-gray-700 dark:text-white/70">
