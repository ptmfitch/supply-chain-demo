        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              placeholder={
                ...
                >
                  {type ? (
                    ...
                    <span className="text-gray-500 dark:text-gray-700 dark:text-white/60">Select type</span>
                  )}
                </div>
              }
            >
          ...
          <div className="flex items-center gap-2 p-2 rounded-xl bg-white/5 border border-teal-400/20">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-400 dark:text-gray-700 dark:text-white/50">
                {status
