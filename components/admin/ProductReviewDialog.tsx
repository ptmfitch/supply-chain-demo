        ...
        {Array.from({ length: 5 }, (_, i) => (
          <Star
            ...
            className={cn(
              ...
              i < count
                ? display.starClass
                : "fill-transparent text-gray-400 dark:text-white/40",
            )}
          />
        ))}
      </span>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="space-y-2">
            ...
            <DeferredSelectGate
              ...
              placeholder={
                ...
                <div
                  className={cn(
                    "flex h-auto min-h-11 w-full items-center rounded-md px-2 py-1.5 text-sm text-gray-500 dark:text-white/60",
                    DIALOG_FORM_FIELD_AMBER,
                  )}
                  aria-hidden
                >
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              maxLength={2000}
            />
            <p className="text-xs text-gray-400 dark:text-white/50 text-right">
              {comment.length}/2000
            </p>
          </div>
