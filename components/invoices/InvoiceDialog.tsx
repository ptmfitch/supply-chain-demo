            ...
            <div className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                {selectedOrder && (
                  <div className="rounded-md border border-indigo-400/20 bg-white/5 p-3 space-y-2">
                    ...
                    <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-gray-600 dark:text-white/80">
                      <CopyableText
                      ...
                      {(selectedOrder.placedByName ||
                        ...
                        <AvatarInlineLink
                          ...
                          size={16}
                          linkClassName="text-xs font-normal text-gray-500 dark:text-white/70"
                        />
                      )}
                    </div>
                    {(() => {
                      ...
                      return (
                        <p className="flex flex-wrap items-center gap-x-1.5 gap-y-1 text-xs text-gray-500 dark:text-white/70">
                    ...
                    {selectedOrder.items && selectedOrder.items.length > 0 && (
                      <ul className="space-y-1.5">
                        {selectedOrder.items.map((item) => (
                          <li
                            key={item.id}
                            className="flex items-start gap-2 text-xs text-gray-600 dark:text-white/85 min-w-0"
                          >
                            <ProductThumb
                            ...
                            <span className="min-w-0 flex-1 space-y-0.5">
                              <span className="flex flex-wrap items-baseline gap-x-1.5">
                                ...
                                {item.sku ? (
                                  <span className="shrink-0 font-mono text-[11px] text-gray-500 dark:text-white/60">
                                    · {item.sku}
                                  </span>
                                ) : null}
                              ...
                              {(item.categoryName || item.supplierName) && (
                                <span className="flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[11px] text-gray-500 dark:text-white/60">
                                  {item.categoryName ? (
                                    <span className="inline-flex items-center gap-1">
                                      <Tag
                                  ...
                                  {item.supplierName ? (
                                    <AvatarInlineLink
                                      ...
                                      size={14}
                                      linkClassName="text-[11px] font-normal text-gray-500 dark:text-white/60"
                                    />
                                  ) : null}
                                </span>
                              )}
                            </span>
                            <span className="shrink-0 text-gray-600 dark:text-white/80">
                              {fmt(item.subtotal)}
                            </span>
                          </li>
                        ))}
              ...
              {selectedOrder && (
                <div className="p-4 border border-indigo-400/20 rounded-lg bg-white/5 space-y-2">
                  ...
                  <p className="text-xs text-gray-400 dark:text-white/50 pt-1">
